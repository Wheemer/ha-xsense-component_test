...
[Changelog](../CHANGELOG.md) - הערות גרסה מקושרות לכל גרסה שפורסמה.
...
## תאימות ועדכוני HACS
אם אתה עדיין משתמש בגרסת `v1.2.6.x` ישנה, עדכן ל-`v1.3.14` או חדשה יותר לפני שדרוג Home Assistant Core ל-2026.7 או חדש יותר. הגרסאות הישנות דרשו `aiortc`, שאינו תואם לסביבת Python 3.14 של Home Assistant. גרסאות `v1.4.x` הנוכחיות כבר אינן דורשות `aiortc`.
