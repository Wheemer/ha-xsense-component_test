...
[Changelog](../CHANGELOG.md) - প্ৰতিটো প্ৰকাশিত সংস্কৰণৰ বাবে সংযুক্ত release notes।
...
If you are still using an old `v1.2.6.x` build, update to `v1.3.14` or newer before upgrading Home Assistant Core to 2026.7 or newer. Current `v1.4.x` builds no longer require `aiortc`.
...
- **কেমেৰা (SSC0A, SSC0B)**: ডিভাইচ আৰু একাউণ্টে সমৰ্থন কৰিলে কেমেৰা এণ্টিটি, সৰু পূৰ্বদৃশ্য, Home Assistant live view, নিৰ্ণায়ক তথ্য, আৰু Android app-ৰ সৈতে মিল থকা ছেটিং দেখুওৱা হয়।
...
- কেমেৰা সমৰ্থিত হ’লে কেমেৰা এণ্টিটি, সৰু পূৰ্বদৃশ্য, Home Assistant live view, স্থিতি, আৰু সমৰ্থিত ছেটিং দেখুওৱা হয়।
